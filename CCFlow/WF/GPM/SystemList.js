...
function GoToFrmDesigner(frmID) {
    var url = "../Admin/FoolFormDesigner/GoToFrmDesigner.htm?FK_MapData=" + frmID;
    addTab(url, "设计:" + frmID);
    return;
}
    ...
    mounted: function () {
        ...
        menus.forEach(function (menu) {
            ...
            if (menu.MenuModel == "Windows") {
                ...
                var url = "../Portal/" + menu.Tag1 + ".htm?PageID=" + menu.No;
                ...
                url = "../Portal/" + menu.Tag1+".htm?viewid=Edit&PageID=" + menu.No;
