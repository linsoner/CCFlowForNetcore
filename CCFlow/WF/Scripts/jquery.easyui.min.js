...
a[0].onclick=cceval(btn.handler||function(){
});
...
var t=$(_9b);
return $.extend({},$.parser.parseOptions(_9b,[{total:"number",pageSize:"number",pageNumber:"number"},{loading:"boolean",showPageList:"boolean",showRefresh:"boolean"}]),{pageList:(t.attr("pageList")?cceval(t.attr("pageList")):undefined)});
};
...
t.bind("click",cceval(opts.tools[i].handler));
}
}
}
}
...
tool[0].onclick=cceval(btn.handler||function(){
});
...
$("<a></a>").attr("href","javascript:void(0)").text(_262).css("margin-left",10).bind("click",cceval(_261[_262])).appendTo(tb).linkbutton();
}
}
...
tool[0].onclick=cceval(opts.tools[i].handler||function(){
});
...
item[0].onclick=cceval(_384.onclick);
}
}
if(_384.handler){
item[0].onclick=cceval(_384.handler);
}
_369(_383,item);
if(_384.disabled){
...
var t=$(_3c8);
return $.extend({},$.parser.parseOptions(_3c8,["width","height","prompt","menu"]),{value:t.val(),searcher:(t.attr("searcher")?cceval(t.attr("searcher")):undefined)});
};
...
var th=$(this);
var col=$.extend({},$.parser.parseOptions(this,["field","align","halign","order",{sortable:"boolean",checkbox:"boolean",resizable:"boolean",fixed:"boolean"},{rowspan:"number",colspan:"number",width:"number"}]),{title:(th.html()||undefined),hidden:(th.attr("hidden")?true:undefined),formatter:(th.attr("formatter")?cceval(th.attr("formatter")):undefined),styler:(th.attr("styler")?cceval(th.attr("styler")):undefined),sorter:(th.attr("sorter")?cceval(th.attr("sorter")):undefined)});
if(th.attr("editor")){
...
var t=$(_8b8);
return $.extend({},$.parser.parseOptions(_8b8,["width","height","mode",{reversed:"boolean",showTip:"boolean",min:"number",max:"number",step:"number"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined),rule:(t.attr("rule")?cceval(t.attr("rule")):undefined)});
};
