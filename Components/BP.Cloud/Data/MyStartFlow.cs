    ...
    public class MyStartFlow : Entity
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBString(MyStartFlowAttr.Emps, null, "参与人", false, false, 0, 4000, 100, true);
                map.AddDDLSysEnum(MyStartFlowAttr.TSpan, 0, "时间段", true, false,
                    MyStartFlowAttr.TSpan, "@0=本周@1=上周@2=两周以前@3=三周以前@4=更早");

                //隐藏字段.
                map.AddTBInt(MyStartFlowAttr.WFState, 0, "状态", false, false);
                map.AddTBInt(MyStartFlowAttr.FID, 0, "FID", false, false);
                map.AddTBInt(MyStartFlowAttr.PWorkID, 0, "PWorkID", false, false);
