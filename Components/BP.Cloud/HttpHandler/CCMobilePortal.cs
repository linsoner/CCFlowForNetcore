...
namespace BP.Cloud.HttpHandler
{
    ...
    /// 页面功能实体
    /// </summary>
    public class CCMobilePortal : BP.WF.HttpHandler.DirectoryPageBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public CCMobilePortal()
        {
        ...
        public string GetGenerWorks()
        {
            ...
            //获取审批过未完成的
            dt = new DataTable();
            dt = BP.Cloud.Dev2Interface.DB_GenerRuningNotMyStart(WebUser.No);
            dt.TableName = "Running";
            ds.Tables.Add(dt);

            //获取完成的
            dt = new DataTable();
            dt = BP.Cloud.Dev2Interface.DB_FlowCompleteNotMyStart(WebUser.No);
        ...
        public string GetMyStartGenerWorks()
        {
            DataSet ds = new DataSet();
            //流程处理中的
            //DataTable dt = BP.WF.Dev2Interface.DB_GenerRuning(WebUser.No, null, true);
            DataTable dt = BP.Cloud.Dev2Interface.DB_GenerRuning(WebUser.No,null, true, this.Domain);
            dt.TableName = "Running";
            ds.Tables.Add(dt);
