...
namespace BP.Cloud.OrgSetting
{
    ...
    public class OrgMail : EntityNoName
    {
        ...
        public string SendEmail(string mail, string mailTitle, string mailDoc)
        {
            ...
            string hostUrl = BP.Difference.SystemConfig.GetValByKey("HostURL", "http://172.16.2.251:9200/");
            ...
            try
            {
                ...
                messageToSend.From.Add(new MailboxAddress(orgEmail.SendEmailAddress, orgEmail.SendEmailAddress));
                ...
                {
                    client1.Connect(client.Host, client.Port, false);

                    // Note: only needed if the SMTP server requires authentication
                    client1.Authenticate(orgEmail.SendEmailAddress, orgEmail.SendEmailPass);
