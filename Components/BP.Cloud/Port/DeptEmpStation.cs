    ...
    public class DeptEmpStation : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBString(DeptEmpStationAttr.FK_Station, null, "角色", false, false, 1, 50, 1);
                map.AddTBString(DeptEmpStationAttr.FK_Emp, null, "操作员", false, false, 1, 100, 1);
                map.AddTBString(DeptEmpStationAttr.OrgNo, null, "OrgNo", false, false, 0, 50, 1);
