    ...
    public class OrgExt : EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                #region 字段
                /*关于字段属性的增加 */
                map.AddTBStringPK(OrgExtAttr.No, null, "账号", true, false, 4, 50, 10);
                map.AddTBString(OrgExtAttr.Name, null, "简称", true, false, 0, 200, 130);
                map.AddTBString(OrgExtAttr.NameFull, null, "全称", true, false, 0, 300, 200,true);
                map.AddTBString(OrgExtAttr.Adminer, null, "管理员帐号", true, false, 0, 300, 100);
                map.AddTBString(OrgExtAttr.AdminerName, null, "管理员名称", true, false, 0, 300, 100);

                map.AddTBString(OrgExtAttr.Addr, null, "地址", true, false, 0, 300, 200, true);
                map.AddTBString(OrgExtAttr.GUID, null, "GUID", true, true, 0, 32, 36);

                map.AddDDLSysEnum(OrgExtAttr.RegFrom, 0, "注册来源", true, false,OrgExtAttr.RegFrom,"@0=网站注册@1=微信注册@2=钉钉注册");
                ...
                map.AddTBDateTime(OrgAttr.DTReg, null, "注册日期", true, false);
                map.AddTBDateTime(OrgAttr.DTEnd, null, "停用日期", true, false);

                map.AddDDLSysEnum(OrgExtAttr.OrgSta, 0, "启用状态", true, false, OrgExtAttr.OrgSta, "@0=已卸载@1=使用中");
                #endregion 字段
                ...
                rm = new RefMethod();
                rm.Title = "清除组织";
                rm.Warning = "您确定要删除该组织下的所有数据吗？包括：人员、部门、角色、流程、表单等数据。";
        ...
        public string DoBDelete()
        {
            ...
            DBAccess.RunSQL("DELETE Port_Emp WHERE OrgNo='" + this.No + "'");
            DBAccess.RunSQL("DELETE Port_Dept WHERE OrgNo='" + this.No + "'");
            DBAccess.RunSQL("DELETE Port_DeptEmp WHERE OrgNo='" + this.No + "'");
            DBAccess.RunSQL("DELETE Port_DeptEmpStation WHERE OrgNo='" + this.No + "'");
            DBAccess.RunSQL("DELETE Port_OrgAdminer WHERE OrgNo='" + this.No + "'");
            DBAccess.RunSQL("DELETE Port_Station WHERE OrgNo='" + this.No + "'");
            DBAccess.RunSQL("DELETE Port_StationType WHERE OrgNo='" + this.No + "'");
