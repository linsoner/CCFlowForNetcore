...
namespace BP.Cloud
{
    ...
    public class UserAttr : BP.En.EntityNoNameAttr
    {
        ...
        public const string SOpenID = "SOpenID";

        public const string Token = "Token";


        /// <summary>
        /// 注册来源 0=web,1=qywx, 2=weixin
        /// </summary>
    ...
    public class User : EntityNoName
    {
        ...
        public int RegFrom
        {
            get
            {
                return this.GetValIntByKey(UserAttr.RegFrom);
            }
            set
            {
                this.SetValByKey(UserAttr.RegFrom, value);
            }
        }
        public string SOpenID
        {
            get
            {
                return this.GetValStrByKey(UserAttr.SOpenID);
            }
            set
            {
                this.SetValByKey(UserAttr.SOpenID, value);
            }
        }
        public string SID
        {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBInt(UserAttr.RegFrom, 0, "注册来源0=web,1=qywx,2=wx", true, false);
                ...
                map.AddTBString(UserAttr.SOpenID, null, "小程序的OpenID", true, false, 0, 500, 132, true);
                map.AddTBString(UserAttr.FK_Dept, null, "部门", false, false, 0, 100, 10);

                //微信的ID. BY GUANZHX 20210816
                map.AddTBString(UserAttr.OpenID, null, "OpenID", false, false, 0, 100, 10);
                map.AddTBString(UserAttr.UnionID, null, "UnionID", false, false, 0, 100, 10);
