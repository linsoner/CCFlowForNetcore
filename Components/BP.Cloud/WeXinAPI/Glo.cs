...
namespace BP.Cloud.WeXinAPI
{
    public class Glo
    {
        ...
        public static string MainBuess(XmlDocument xd)
        {
            ...
            if (infoType.Equals("suite_ticket"))
            {
                ...
                //HttpContextHelper.Current..Response.WriteAsync("success");
                return "success";
            }
        ...
        public static string InstallIt(string authCode)
        {
            ...
            //写入到 Port_Org
            Insert_Port_Org(org, authCorpInfoJtoken, corpId, permanentCode, accessToken);
            ...
            //如果是科伦bpm.
            if (BP.Difference.SystemConfig.CustomerNo.Equals("CCFlow") == true)
            {
                //获取部门列表，插入数据库.
            ...
            //如果是访客系统.
            if (BP.Difference.SystemConfig.CustomerNo.Equals("FangKe") == true)
            {
                //获取部门列表，插入数据库.
                createDept(org, permanentCode);
    ...
    */
        ...
        public static void Insert_Port_Org(Org org, JToken authCorpInfoJtoken, string corpId, string permanentCode, string accessToken)
        {
        ...
        public static void SendMsg(string sender, string toUserIDs, string title, string docs, string url, string orgNo)
        {
            ...
            //增加消息链接.
            if (DataType.IsNullOrEmpty(url) == false)
                docs += " 打开链接: " + url;
                ...
                Convert.ToDateTime(org.AccessTokenExpiresIn)) > 0)
            {
               ...
               // BP.WF.Dev2Interface.Node_FHL_KillSubFlow()
