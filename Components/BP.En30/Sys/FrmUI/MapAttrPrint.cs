...
namespace BP.Sys.FrmUI
{
    ...
    /// 打印组件
    /// </summary>
    public class MapAttrPrint : EntityMyPK
    {
        #region 文本字段参数属性.
        /// <summary>
        /// 表单ID
        ...
        /// 实体属性
        /// </summary>
        public MapAttrPrint(string myPK)
        {
            this.setMyPK(myPK);
            this.Retrieve();
    ...
    /// 打印组件s
    /// </summary>
    public class MapAttrPrints : EntitiesMyPK
    {
        #region 构造
        /// <summary>
        /// 打印组件s
        ...
        public System.Collections.Generic.IList<MapAttrPrint> ToJavaList()
        {
            return (System.Collections.Generic.IList<MapAttrPrint>)this;
        }
        /// <summary>
        /// 转化成list
        /// </summary>
        /// <returns>List</returns>
        public System.Collections.Generic.List<MapAttrPrint> Tolist()
        {
            System.Collections.Generic.List<MapAttrPrint> list = new System.Collections.Generic.List<MapAttrPrint>();
            for (int i = 0; i < this.Count; i++)
            {
                list.Add((MapAttrPrint)this[i]);
            }
            return list;
        }
