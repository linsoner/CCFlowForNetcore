...
namespace BP.CCBill.Template
{
    ...
    /// 新建实体流程
    /// </summary>
    public class CollectionFlowNewEntity : EntityNoName
    {
        #region 基本属性
        /// <summary>
        /// 表单ID
        ...
        public CollectionFlowNewEntity(string no)
        {
            this.No = no;
            this.Retrieve();
        }
    ...
    /// 新建实体流程
    /// </summary>
    public class CollectionFlowNewEntitys : EntitiesNoName
    {
        /// <summary>
        /// 新建实体流程
        /// </summary>
        ...
        public System.Collections.Generic.IList<CollectionFlowNewEntity> ToJavaList()
        {
            return (System.Collections.Generic.IList<CollectionFlowNewEntity>)this;
        }
        /// <summary>
        /// 转化成list
        /// </summary>
        /// <returns>List</returns>
        public System.Collections.Generic.List<CollectionFlowNewEntity> Tolist()
        {
            System.Collections.Generic.List<CollectionFlowNewEntity> list = new System.Collections.Generic.List<CollectionFlowNewEntity>();
            for (int i = 0; i < this.Count; i++)
            {
                list.Add((CollectionFlowNewEntity)this[i]);
            }
            return list;
        }
