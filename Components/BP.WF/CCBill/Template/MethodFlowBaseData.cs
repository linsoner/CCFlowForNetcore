...
namespace BP.CCBill.Template
{
    ...
    /// 基础数据变更
    /// </summary>
    public class MethodFlowBaseData : EntityNoName
    {
        #region 基本属性
        /// <summary>
        /// 表单ID
        ...
        public MethodFlowBaseData(string mypk)
        {
            this.No = mypk;
            this.Retrieve();
        }
    ...
    /// 基础数据变更
    /// </summary>
    public class MethodFlowBaseDatas : EntitiesNoName
    {
        /// <summary>
        /// 基础数据变更
        /// </summary>
        ...
        public System.Collections.Generic.IList<MethodFlowBaseData> ToJavaList()
        {
            return (System.Collections.Generic.IList<MethodFlowBaseData>)this;
        }
        /// <summary>
        /// 转化成list
        /// </summary>
        /// <returns>List</returns>
        public System.Collections.Generic.List<MethodFlowBaseData> Tolist()
        {
            System.Collections.Generic.List<MethodFlowBaseData> list = new System.Collections.Generic.List<MethodFlowBaseData>();
            for (int i = 0; i < this.Count; i++)
            {
                list.Add((MethodFlowBaseData)this[i]);
            }
            return list;
        }
