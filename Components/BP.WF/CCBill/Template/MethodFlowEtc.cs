...
namespace BP.CCBill.Template
{
    ...
    /// 实体其他业务流程
    /// </summary>
    public class MethodFlowEtc : EntityNoName
    {
        #region 基本属性
        /// <summary>
        /// 表单ID
        ...
        public MethodFlowEtc(string mypk)
        {
            this.No = mypk;
            this.Retrieve();
        }
    ...
    /// 实体其他业务流程
    /// </summary>
    public class MethodFlowEtcs : EntitiesNoName
    {
        /// <summary>
        /// 实体其他业务流程
        /// </summary>
        ...
        public System.Collections.Generic.IList<MethodFlowEtc> ToJavaList()
        {
            return (System.Collections.Generic.IList<MethodFlowEtc>)this;
        }
        /// <summary>
        /// 转化成list
        /// </summary>
        /// <returns>List</returns>
        public System.Collections.Generic.List<MethodFlowEtc> Tolist()
        {
            System.Collections.Generic.List<MethodFlowEtc> list = new System.Collections.Generic.List<MethodFlowEtc>();
            for (int i = 0; i < this.Count; i++)
            {
                list.Add((MethodFlowEtc)this[i]);
            }
            return list;
        }
