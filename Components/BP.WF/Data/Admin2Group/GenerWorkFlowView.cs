    ...
    public class GenerWorkFlowView : Entity
    {
        ...
        public override Map EnMap
        {
            get
            {
               ...
               // map.AddDDLSysEnum(GenerWorkFlowAttr.WFState, 0, "大状态", true, false, "WFState");
             ...
             //   map.AddDDLEntities(GenerWorkFlowAttr.FK_FlowSort, null, "类别", new FlowSorts(), false);
                map.AddDDLEntities(GenerWorkFlowAttr.FK_Flow, null, "流程", new BP.WF.Data.FlowSimples(), false);
