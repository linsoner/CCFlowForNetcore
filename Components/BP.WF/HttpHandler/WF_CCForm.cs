...
namespace BP.WF.HttpHandler
{
    ...
    public class WF_CCForm : DirectoryPageBase
    {
        ...
        public string FrmImgAthDB_Cut()
        {
            ...
            string savePath = BP.Difference.SystemConfig.CCFlowAppPath + "DataUser/ImgAth/Data/" + newName + ".png";
            //获取上传的大图片
        ...
        public string WpsFrm_SaveFile()
        {
            ...
            var file = HttpContextHelper.RequestFiles()[0];  //context.Request.Files;
